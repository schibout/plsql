...
|---|---|---|
| Présence et complétude des fichiers | 212 fichiers | **Conforme** |
| Montants et volumes sur les fichiers d'origine | 106 fichiers | **Conforme** |
| Montants et volumes sur les envois regroupés vers la banque | 92 envois | **Conforme** |
| Comparaison virement par virement (bénéficiaire, montant, banque) | 975 virements | **Conforme** |
| Envois transmis plusieurs fois à la banque | 106 envois | **Conforme** |
| Envois se recouvrant partiellement | 106 envois | **Conforme** |
| Virements présents dans plusieurs envois du jour | 106 envois | **Conforme** |
| Virements en double au sein d'un même envoi | 106 envois | **Conforme** |
| Envois ou virements déjà transmis un jour précédent | 2 journée(s) comparée(s) | **Conforme** |
| Fichiers d'origine rejoués | 106 envois | **Conforme** |
| Contrôles de forme sur les envois | 106 envois | **Conforme** |
| Rapprochement avec le retour de la trésorerie | 975 repris / 975 envoyés | **Conforme** |

Montant total transmis à la banque sur la journée : **11 016 492,91 EUR** pour **975 virements**.

Montant total repris par la trésorerie : **11 016 492,91 EUR** pour **975 virements**.
