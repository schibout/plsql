...
|---|---|---|
| Présence et complétude des fichiers | 96 fichiers | **Conforme** |
| Montants et volumes sur les fichiers d'origine | 48 fichiers | **Conforme** |
| Montants et volumes sur les envois regroupés vers la banque | 36 envois | **Conforme** |
| Comparaison virement par virement (bénéficiaire, montant, banque) | 222 virements | **Conforme** |
| Envois transmis plusieurs fois à la banque | 48 envois | **Conforme** |
| Envois se recouvrant partiellement | 48 envois | **Conforme** |
| Virements présents dans plusieurs envois du jour | 48 envois | **Conforme** |
| Virements en double au sein d'un même envoi | 48 envois | **Conforme** |
| Envois ou virements déjà transmis un jour précédent | 2 journée(s) comparée(s) | **Conforme** — 🟠 1 à vérifier |
| Fichiers d'origine rejoués | 48 envois | **Conforme** |
| Contrôles de forme sur les envois | 48 envois | **Conforme** |
| Rapprochement avec le retour de la trésorerie | — | *Non réalisé : l'export de la trésorerie n'a pas été fourni* |

Montant total transmis à la banque sur la journée : **2 200 148,81 EUR** pour **222 virements**.
...
|---|---|---|---|---|---|---|---|
| ad23324a0d19453a970a64c54d9a78f6 | CDPG.NC4.IMPORT_ACK.DLK_VIR_17897792449159068.PY_TRANSFER.I_DAL_VIR.DALKIA.NULL | VIREMENT_DEJA_ENVOYE | 18092026 | CDPG.NC4.IMPORT_ACK.DLK_VIR_17896890395209027.PY_TRANSFER.I_DAL_VIR.DALKIA.NULL | 1 | 438,00 EUR | RESEAU SERVICES SOCIAUX / FR7616807004008056415260350 deja paye le 18092026 |
