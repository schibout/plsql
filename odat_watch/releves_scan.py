"""Relevés bancaires — acquisition : configuration, lecture AFB120, scan des dossiers PFE / EBS, parseurs des logs
RBAFBIMP et DKA_SRBCTRLRB, comptes connus, chaîne Control-M (photos ODAT) et scan global.

Le verdict de la matinée, la continuité et le plan de reprise sont dans releves.py.
"""
