...
REM On lance PowerShell en lui demandant de lire et d'executer ce meme fichier
PowerShell -NoProfile -ExecutionPolicy Bypass -Command ". ([ScriptBlock]::Create((Get-Content -LiteralPath '%~f0' -Raw)))" %*
EXIT /B %ERRORLEVEL%
#>

# =====================================================================
# Code PowerShell (ignore par le Batch grace aux balises <# : et #>)
# =====================================================================
...
# Correction du repertoire de travail pour le script polyglotte
