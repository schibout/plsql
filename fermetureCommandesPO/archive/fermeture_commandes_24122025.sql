...
-- 
-- SOURCE : Liste fournie le 24/12/2025 (24 commandes)
-- =====================================================================
...
BEGIN
    ...
    l_po_header_ids := t_po_list(
        4088683, 2203568, 2436488, 2780554, 4088684,
        2071333, 2436796, 3591452, 3495828, 4088686,
        3231684, 4097556, 2904730, 2770651, 2176409,
        2970687, 3495689, 3524692, 2436794, 4219896,
        3876740, 4161864, 3610067, 4161868
    );
