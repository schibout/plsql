...
BEGIN
    ...
    l_po_header_ids := t_po_list(
        2786779, 2919980, 4088703, 3677228, 3522711,
        3695620, 3523655, 2203566, 4098888, 2970688,
        3227403, 4216645, 4022684, 2910375, 3495703,
        4383547, 4228891, 2739568, 2206967, 2786778,
        2786354, 4086064, 2436483, 4098688
    );
