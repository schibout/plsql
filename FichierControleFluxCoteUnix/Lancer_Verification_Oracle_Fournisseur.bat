@echo off
:: Lanceur - Verification des factures FAC02 FOURNISSEURS dans Oracle EBS
:: Usage : Lancer_Verification_Oracle_Fournisseur.bat [dossier_source ^| fichier_SRC]
...
if not exist "%DOSSIER_SOURCE%" set "DOSSIER_SOURCE=FAC02FACTURESFOURNISSEURS\SOURCE"
if not exist "%DOSSIER_SOURCE%" set "DOSSIER_SOURCE=FichierControleFluxCoteUnix\FAC02FACTURESFOURNISSEURS\SOURCE"
...
echo =======================================================================
echo Verification Oracle FOURNISSEURS avec le fichier : %FICHIER_ENTREE%
echo =======================================================================
echo.

powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0Verifier_Oracle_FAC02_Fournisseur.ps1" -CheminFichierSrc "%FICHIER_ENTREE%"
